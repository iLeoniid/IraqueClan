...
public class MembersLeaderboard extends BaseMenu {
    private final IraqueClan plugin;

    public MembersLeaderboard(IraqueClan plugin, Player player) {
        super(player, "&#555555&lMembros", 54, MenuType.SIMPLE);
        this.plugin = plugin;
    }
    ...
    public void buildMenu() {
        ...
        this.registerButton(4, new MenuButton(
                ...
                "&#4ecdc4&lRanking de Membros",
                List.of("", " &#AAAAAACl\u00e3s com mais membros", ""),
                p -> {}
        ));

        List<Clan> clans = this.plugin.getClanManager().getClansSortedByMembers();
        ...
        for (int i = 0; i < Math.min(clans.size(), 45); i++) {
            ...
            this.registerButton(i + 10, new MenuButton(
                    ...
                    List.of(
                            "",
                            " &#AAAAAAMembros: &#55FFFF" + clan.getMemberCount() + "/" + clan.getMaxMembers(),
